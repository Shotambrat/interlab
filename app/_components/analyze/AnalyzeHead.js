...
export default function AnalyzeHead() {
  return (
      ...
      <div className="w-full max-w-[1440px] flex justify-between py-12 max-mdx:py-6 mx-auto">
        <div className="flex flex-col gap-4">
          <h1 className="font-bold mdx:text-3xl text-2xl slg:text-4xl">
            Общий анализ мочи с микроскопией, ОАМ
          </h1>
          <p className="text-neutral-400 text-sm w-full max-w-[600px]">
            Исследование, используещееся для оценки мочеобразования и
            мочевыделения, и оценки общего состояния организма человека
          </p>
