...
const ServiceCard = ({ title, description, imageSrc, bgColor, bgHoverColor }) => (
  <section
    ...
    <>
      <div className="flex flex-col bg-white px-2 lg:px-16">
        ...
        <div className="flex flex-col self-center mdx:px-5 mt-60 w-full max-w-[1440px] max-md:mt-10 max-md:max-w-full">
          ...
          <section className="flex gap-5 justify-between mt-52 slg:flex-nowrap flex-wrap max-md:mt-10 max-md:max-w-full">
                    ...
                    <div className="flex flex-col text-xl text-neutral-900 max-md:max-w-full">
                      <div className="flex gap-3 max-md:flex-wrap">
                        ...
                        <p className="max-md:max-w-full">
                          Не употребляйте пищу за 8-12 часов до сдачи анализа
                          (если требуется натощак)
                        </p>
                      </div>
                      ...
                      <div className="flex gap-3 mt-6 max-md:flex-wrap">
                        ...
                        />
                        <p className="max-md:max-w-full">
                          Исключить физическое напряжение (бег, быстрый подъем
                          по лестнице)
                        </p>
                      </div>
                    </div>
