...
export default function ContactWithUs({ close }) {
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-60 z-50">
      <div className="bg-white p-4 rounded-3xl shadow-lg max-mdx:w-[320px] w-[450px]">
        <div className="flex w-full justify-between items-center">
          <h1 className="text-2xl font-semibold">Связаться с нами</h1>
          <button onClick={close}>X</button>
        </div>
        <div className="mt-5 flex flex-col gap-4">
          <button className="px-4 border border-rose-500 bg-rose-100 py-4 rounded-lg flex justify-between items-center">
          ...
          <button className="px-4 border border-blue-500 bg-blue-100 py-4 rounded-lg flex justify-between items-center">
            <div className="flex items-center">
              <div className="mr-4">
              <Image
                priority
              ...
              <p className="text-blue-500 font-semibold text-lg">Написать в Telegram</p>
            </div>
            <div>
              <Image
                priority
          ...
          <button className="px-4 border border-indigo-500 bg-indigo-100 py-4 rounded-lg flex justify-between items-center">
            <div className="flex items-center">
              ...
              <p className="text-indigo-500 font-semibold text-lg">Оставить заявку</p>
            </div>
            <div>
              <Image
                priority
