      ...
      <div className="w-full max-w-[1440px] mx-auto mt-24">
        <div className="container mx-auto py-8">
          ...
          <div className="grid grid-cols-1 mdl:grid-cols-2 text-rose-400">
            <div className="p-6 border-b mdl:border-r border-gray-200">
            ...
            <div className="p-6 mdl:border-l border-b border-gray-200 ">
            ...
            <div className="p-6 mdl:border-t mdl:border-r border-gray-200">
              <h3 className="text-2xl font-semibold mb-4">
              {t('title3')}
              </h3>
              <p className="text-[#5B5B5B]">
            ...
            <div className="p-6 border-t mdl:border-l border-gray-200">
